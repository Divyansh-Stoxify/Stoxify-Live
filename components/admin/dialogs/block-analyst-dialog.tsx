...
export function BlockAnalystDialog({ analystId, currentState, refresh, trigger }: Props) {
  ...
  return (
    <ConfirmDialog
      ...
      onConfirm={async () => {
        const res = await adminFetch(`/api/admin/analysts/${encodeURIComponent(analystId)}/block`, {
          method: "POST",
