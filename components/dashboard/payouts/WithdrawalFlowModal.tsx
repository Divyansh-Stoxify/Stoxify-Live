...
export default function WithdrawalFlowModal({
  isOpen,
  onClose,
  withdrawableBalance,
        ...
        {step === 4 && (
          <div className="text-center py-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-6">
              ₹{parseFloat(amount).toLocaleString("en-IN")} will be sent to XXXXXXXXX1234. Usually
              takes within 30 minutes.
            </p>
            <button
              onClick={resetAndClose}
              className="px-6 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-900 dark:text-white rounded-lg"
            >
              Close
            </button>
          </div>
