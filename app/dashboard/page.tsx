...
import { useDashboardMetrics } from "@/app/lib/hooks/use-dashboard-metrics";
import { useActiveTrades } from "@/app/lib/hooks/use-trades";
import { useRecentSubscribers } from "@/app/lib/hooks/use-subscribers";
import type { Trade, Subscriber } from "@/app/lib/types";
