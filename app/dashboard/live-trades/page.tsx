...
import { useActiveTrades, usePendingTrades, useClosedTrades } from "@/app/lib/hooks/use-trades";
import { useLiveTradesStats } from "@/app/lib/hooks/use-dashboard-metrics";
import { useDashboard } from "@/app/components/dashboard/dashboard-context";
import type { Trade } from "@/app/lib/types";
    ...
    <div className="rounded-xl border border-[var(--line)] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.04)] overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-5 py-3.5 border-b border-[var(--line)]">
        ...
        <span className="text-[11px] text-[var(--muted-2)]">
          Created: {formatCreatedTime(trade.created_at)}
        </span>
