      ...
      <div className="max-w-[1000px]">
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white border border-[var(--line)] rounded-2xl p-5 shadow-[0_1px_4px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.04)] hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between min-h-[120px]">
            ...
            {/* Watermark Icon */}
            <Icon
              className="absolute -right-4 -bottom-6 h-20 w-20 text-amber-500 opacity-[0.03] group-hover:opacity-[0.08] group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 ease-out pointer-events-none"
              name="eye"
            />
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[12.5px] font-medium text-[var(--muted)] flex items-center gap-1 group-hover:text-[var(--ink)] transition-colors">
                Page Views
                <Icon
                  className="h-3 w-3 text-[var(--muted-2)] opacity-40 hover:opacity-100 cursor-help transition-opacity"
                  name="helpCircle"
                  title="Total page views of this batch's landing page"
                />
              </span>
            </div>
          ...
          <div className="bg-white border border-[var(--line)] rounded-2xl p-5 shadow-[0_1px_4px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.04)] hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between min-h-[120px]">
            ...
            {/* Watermark Icon */}
            <Icon
              className="absolute -right-4 -bottom-6 h-20 w-20 text-emerald-500 opacity-[0.03] group-hover:opacity-[0.08] group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 ease-out pointer-events-none"
              name="rupee"
            />
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[12.5px] font-medium text-[var(--muted)] flex items-center gap-1 group-hover:text-[var(--ink)] transition-colors">
                ...
                <Icon
                  className="h-3 w-3 text-[var(--muted-2)] opacity-40 hover:opacity-100 cursor-help transition-opacity"
                  name="helpCircle"
                  title="Total revenue generated from subscribers of this batch"
                />
              </span>
            </div>
            <div className="text-[32px] font-extrabold leading-none tracking-tight text-[var(--ink)] mt-3.5 tabular-nums">
          ...
          <div className="bg-white border border-[var(--line)] rounded-2xl p-5 shadow-[0_1px_4px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.04)] hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between min-h-[120px]">
            ...
            {/* Watermark Icon */}
            <Icon
              className="absolute -right-4 -bottom-6 h-20 w-20 text-blue-500 opacity-[0.03] group-hover:opacity-[0.08] group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 ease-out pointer-events-none"
              name="users"
            />
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[12.5px] font-medium text-[var(--muted)] flex items-center gap-1 group-hover:text-[var(--ink)] transition-colors">
                ...
                <Icon
                  className="h-3 w-3 text-[var(--muted-2)] opacity-40 hover:opacity-100 cursor-help transition-opacity"
                  name="helpCircle"
                  title="Total active subscribers in this batch"
                />
              </span>
            </div>
            <div className="text-[32px] font-extrabold leading-none tracking-tight text-[var(--ink)] mt-3.5 tabular-nums">
          ...
          <div className="bg-white border border-[var(--line)] rounded-2xl p-5 shadow-[0_1px_4px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_24px_rgba(0,0,0,0.04)] hover:-translate-y-0.5 transition-all duration-300 relative overflow-hidden group flex flex-col justify-between min-h-[120px]">
            ...
            {/* Watermark Icon */}
            <Icon
              className="absolute -right-4 -bottom-6 h-20 w-20 text-red-500 opacity-[0.03] group-hover:opacity-[0.08] group-hover:scale-110 group-hover:rotate-6 transition-all duration-500 ease-out pointer-events-none"
              name="activity"
            />
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-[12.5px] font-medium text-[var(--muted)] flex items-center gap-1 group-hover:text-[var(--ink)] transition-colors">
                ...
                <Icon
                  className="h-3 w-3 text-[var(--muted-2)] opacity-40 hover:opacity-100 cursor-help transition-opacity"
                  name="helpCircle"
                  title="Percentage of subscribers who cancelled their subscription"
                />
              </span>
            </div>
            <div className="text-[32px] font-extrabold leading-none tracking-tight text-[var(--ink)] mt-3.5 tabular-nums">
            ...
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-[14px] font-bold text-[var(--ink)] tracking-tight flex items-center gap-1.5">
                ...
                <Icon
                  className="h-3 w-3 text-[var(--muted-2)] opacity-40 hover:opacity-100 cursor-help transition-opacity"
                  name="helpCircle"
                  title="List of members currently subscribed to this batch workspace"
                />
              </h3>
              <Link
            ...
            <div className="flex-1 flex flex-col overflow-y-auto pr-1 no-scrollbar">
              {isSubscribersLoading ? (
                ...
                <div className="flex flex-col gap-2.5">
                  {subscribers.slice(0, 5).map((sub) => (
                    <div
                      ...
                      className="flex items-center gap-3 p-2.5 hover:bg-slate-50/80 rounded-xl transition-all border border-transparent hover:border-[var(--line)]/50 group/item"
                    >
                      {sub.user_avatar ? (
                        <img
                          alt={sub.user_name}
                          className="h-9 w-9 shrink-0 rounded-xl object-cover border border-[var(--line)]/60 transition-transform duration-300 group-hover/item:scale-105"
                          src={sub.user_avatar}
                        />
                      ) : (
                        <div
                          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl text-[11px] font-extrabold text-white transition-transform duration-300 group-hover/item:scale-105"
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="text-[13px] font-bold text-[var(--ink)] truncate group-hover/item:text-[var(--brand)] transition-colors">
                          {sub.user_name}
                        </div>
                        <div className="text-[11px] text-[var(--muted-2)] truncate mt-0.5">
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-center py-4">
                  ...
                  <h4 className="text-[13.5px] font-bold text-[var(--ink)] mb-0.5">
                    No members yet
                  </h4>
            ...
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-[14px] font-bold text-[var(--ink)] tracking-tight flex items-center gap-1.5">
                ...
                <Icon
                  className="h-3 w-3 text-[var(--muted-2)] opacity-40 hover:opacity-100 cursor-help transition-opacity"
                  name="helpCircle"
                  title="Recent billing history and subscription payments"
                />
              </h3>
              <Link
              ...
              {isSubscribersLoading ? (
                ...
                <div className="flex flex-col gap-2.5">
                  {subscribers.slice(0, 5).map((sub) => (
                    <div
                      key={sub.subscription_id}
                      className="flex items-center justify-between p-2.5 hover:bg-slate-50/80 rounded-xl transition-all border border-transparent hover:border-[var(--line)]/50 group/item"
                    >
            ...
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-[14px] font-bold text-[var(--ink)] tracking-tight flex items-center gap-1.5">
                ...
                <Icon
                  className="h-3 w-3 text-[var(--muted-2)] opacity-40 hover:opacity-100 cursor-help transition-opacity"
                  name="helpCircle"
                  title="Active coupons and discount campaigns for this batch"
                />
              </h3>
              <Link
              ...
              {isCouponsLoading ? (
                ...
                <div className="flex flex-col gap-2.5">
                  {coupons.slice(0, 5).map((coupon) => (
                    <div
                      key={coupon.code}
                      className="flex items-center justify-between text-[12.5px] font-semibold text-[var(--ink)] px-3.5 py-2.5 border border-dashed border-[var(--line)] rounded-xl bg-slate-50/35 hover:border-pink-300 hover:bg-pink-50/20 transition-all duration-200 group/coupon"
                    >
                      <div className="flex items-center gap-2 min-w-0 pr-2">
                        ...
                        <span
                          className="font-mono font-bold tracking-wider truncate text-[13px] text-[var(--ink)]"
                          title={coupon.code}
                        >
                          {coupon.code}
                        </span>
